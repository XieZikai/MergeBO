...
def bo_loop(dim, benchmark_index, kernel_type):
    ...
    for nruns in range(20):
        ...
        for num_iters in range(n_init, n_evals):
            ...
            if kernel_type == 'random_comparison':
            ...
            file_name = 'tsp_botorch_' + kernel_type + '_EI_dim_' + str(
                dim) + 'benchmark_index_' + str(benchmark_index)
...
if __name__ == '__main__':
    ...
    parser_.add_argument('--kernel_type', dest='kernel_type', type=str, default='random_comparison')
